        ...
        <div id="profile-header" class="comp-box">
            <div class="short-header profile-header edit">
                <div class="profile-cover">
                    ...
                    <a class="inner-link-list" href="javascript:void(0)" style="z-index:1000;padding-left: 10px;padding-top: 10px;" title="Danh mục các hạng mục nhà thầu"><i class="fa fa-bars" style="font-size: 21px;color:#349134;"></i></a>
