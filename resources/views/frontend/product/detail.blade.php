            ...
            <header>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb-product breadcrumb-nowrap breadcrumb breadcrumb-angle bg-transparent pl-0 pr-0 mb-0">
                  <li class="breadcrumb-item"><a href="javascript:void(0)">All Games</a></li>
                  <li class="breadcrumb-item"><a href="javascript:void(0)">Action Games</a></li>
                ...
                <div class="product-body">
                  ...
                  <div class="carousel-product">
                    <div class="slider text-secondary slider-for" data-slick="product-body">
                      ...
                      <img src="{{$dowloadfile}}" alt="Game">
                      @endforeach
                    </div>
                    
                    <div class=" slider slider-nav slider product-slider-nav text-secondary ">
                      @foreach(explode(',', $detail_product->images) as $key => $dowloadfile)
                      <div class="slide-item px-1" style="width: 10px; display: inline-block;"><img src="{{$dowloadfile}}" class="screenshot" alt="Game"></div>
                      @endforeach
                    </div>
                        ...
                        <div class="tab-pane fade active show" id="fillup-1" role="tabpanel" aria-labelledby="fillup-home-tab">
                          <div class="row">
                            <div class="col-xs-12 col-lg-6 mb-6 mb-lg-0">
                              <div class="row">
                                <div class="col-12">
                                  <span class="d-inline-block text-uppercase fw-500 mb-3 text-info">{{$detail_product->content}}</span>
                                </div>
                              </div>
          ...
          <div class="col-lg-4">
            <div class="bg-dark_A-20 p-4 mb-4">
              ...
              <div class="price-wrapper">
                <div class="mb-3">
                  <div class="price">
                    <div class="price-prev">{{$detail_product->price}}</div>
                    <div class="price-current">{{$detail_product->sale_price}}</div>
                  </div>
                  <div class="discount">
                    Save: {{$detail_product->price- $detail_product->sale_price}} (-{{round(($detail_product->price-$detail_product->sale_price)/ ($detail_product->price/100))}}%)
                  </div>
                </div>
