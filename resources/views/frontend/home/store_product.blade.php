...
<body class="page-body">
  ...
  <main class="main-content">
    ...
    <div class="overlay overflow-hidden pe-n"><img src="assets2/img/bg/bg_shape.png" alt="Background shape"></div>
        ...
        <div class="row gutters-y">
                ...
                <div class="product-body">
                  ...
                  <div class="carousel-product">
                    <div class="slider text-secondary" data-slick="product-body">
                      <img src="assets2/img/content/product/01.jpg" alt="Game">
                      <img src="assets2/img/content/product/02.jpg" alt="Game">
                      <img src="assets2/img/content/product/03.jpg" alt="Game">
                      <img src="assets2/img/content/product/05.jpg" alt="Game">
                      <img src="assets2/img/content/product/04.jpg" alt="Game">
                    </div>
                    <div class="slider product-slider-nav text-secondary">
                      <div class="slide-item px-1"><img src="assets2/img/content/product/01.jpg" class="screenshot" alt="Game"></div>
                      <div class="slide-item px-1"><img src="assets2/img/content/product/02.jpg" class="screenshot" alt="Game"></div>
                      <div class="slide-item px-1"><img src="assets2/img/content/product/03.jpg" class="screenshot" alt="Game"></div>
                      <div class="slide-item px-1"><img src="assets2/img/content/product/05.jpg" class="screenshot" alt="Game"></div>
                      <div class="slide-item px-1"><img src="assets2/img/content/product/04.jpg" class="screenshot" alt="Game"></div>
                    </div>
                  </div>
                  <!--/.Carousel Wrapper-->
          ...
          <div class="col-lg-4">
            <div class="bg-dark_A-20 p-4 mb-4">
              <img src="assets2/img/content/store/h-10.jpg" alt="Product" class="mb-3">
    ...
    <section class="container text-light">
      <div class="border border-secondary py-5 px-2">
        ...
        <div class="owl-carousel" data-carousel-items="1, 2, 3, 6">
          <div class="item mx-3">
            <img src="assets2/img/content/store/h-01.jpg" alt="Game" class="mb-3">
          ...
          <div class="item mx-3">
            <img src="assets2/img/content/store/h-02.jpg" alt="Game" class="mb-3">
